...
return [
    ...
    AbstractSystemNotification::TYPE_CONTRACT_DRAFT_OFFERED => 'Project Draft Scope #:version has been proposed by the :role. Both Parties are required to accept the Terms to proceed',
    AbstractSystemNotification::TYPE_CONTRACT_DRAFT_REJECTED => 'Project Draft Scope #:version has been declined',
    AbstractSystemNotification::TYPE_CONTRACT_DRAFT_PROPOSED => 'Project Draft Scope #:version - Different Terms have been proposed. Both Parties are required to accept the Terms to proceed',
...
//    AbstractSystemNotification::TYPE_CONTRACT_COMPLETED => 'Good news. The status for Project ":project_name" is now Completed. Your 88Day Workmanship Guarantee has now been activated, and your review is shown below.',
    AbstractSystemNotification::TYPE_CONTRACT_COMPLETED => 'Ok Great. The status for Project “:project_name” is updated to Completed. Your 88 Day Workmanship Guarantee has been activated. The review you left for the Pro is shown below.',

    AbstractSystemNotification::TYPE_INVOICE_CREATED => 'Payment request for milestone #:sequence  has been issued.',
    ...
    AbstractSystemNotification::TYPE_MILESTONE_CONTENT_EDITED => 'Milestone #:milestone_sequence.:version edit has been proposed ',
    AbstractSystemNotification::TYPE_MILESTONE_CONTENT_ACCEPTED => 'Milestone #:milestone_sequence.:version edit has been accepted',
    AbstractSystemNotification::TYPE_MILESTONE_CONTENT_REJECTED => 'Milestone #:milestone_sequence.:version edit has been declined',
    ...
    AbstractSystemNotification::TYPE_SUMMARY_READY => 'Project Milestones are completed, and a Project Summary is ready to view',
