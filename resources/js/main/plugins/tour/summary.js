export default {
    ...
    methods: {
        ...
        updateStepsHo() {
            ...
            } else if (this.summary.contract.status === 'finished' && this.summary.contract.ho_confirm_complete){
        ...
        updateStepsPro() {
            if(this.summary.contract.status === 'finished' && (this.summary.contract.ho_confirm_complete || this.user.role === 'contractor')){
                const tick_a = {
                ...
                if(this.summary.contract.ho_confirm_complete){
                    const tick_b = {
            ...
            } else if (this.summary.contract.status === 'completed' && this.needConfirmComplete === false){
                const tick_a = {
