        ...
        <template v-if="desktop_only">
            <div class="row row-mobile">
                <div class="col-xl-9 col-lg-12 col-12 custom-col-mobile">
                    ...
                    <div class="contract-comp__body component-body_scroll scrollbar pa-0" :style="{height: component_container_height}">
                        <div class="contract-invoice__list">
                            <invoice data-v-step="ilho-3"  :key="invoice.id" v-for="invoice in invoices" :invoice="invoice"></invoice>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 hidden-md-and-down">
                    <contract-timeline :timeline="timeline"></contract-timeline>
                </div>
            </div>
        </template>
        <template v-else>
            ...
            <div :style="{height: component_container_height}" class="contract-comp__body component-body_scroll scrollbar">
                <div class="contract-invoice__list">
                    ...
                    <invoice data-v-step="ilho-3" v-for="invoice in invoices"
                             :key="invoice.id"
                             :invoice="invoice">
                    </invoice>
                </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            desktop_only(){ return window.innerWidth >= 992 },
