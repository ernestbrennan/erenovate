        ...
        <div class="main-dialog main-dialog_open">
            ...
            <div class="main-dialog__body">
                ...
                <p class="main-dialog__p">
                    ...
                    Once we receive your payment, we’ll notify your client that the Guarantee is activated and project is ready to start.
                </p>
                <p class="main-dialog__p">
                    Click the PayPal button below to pay the Guarantee Fee.
                </p>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            approvePayment(data, details){
                ...
                api.post('payment.contractFee', {
                    order_id: data.orderID,
                    contract_draft_id: this.contract_draft_id
                })
                    .then(response => {
