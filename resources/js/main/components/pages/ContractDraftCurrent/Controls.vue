        ...
        <v-dialog light max-width="556" v-model="dialogMain" content-class="main-dialog__scroll-content scrollbar">
            ...
            <div class="main-dialog main-dialog_open">
                ...
                <div class="main-dialog__body">
                    ...
                    <div v-if="typeof currentDialog.comment !== 'undefined' || currentDialog.comment !== false" class="main-dialog__form-group">
                ...
                <div class="main-dialog__footer">
                    <div class="main-dialog__footer-btn-row">
                        ...
                        <button class="main-btn main-btn_full-blue" @click="dialogAction(currentDialog.activateName)" :disabled="loading">
...
<script>
    ...
    import {dialogContractPropose,currentDialog,dialogRejectDraft,dialogAcceptDraft ,dialogProposalConfirm} from '../../dialog/contractDraftCurrent'
