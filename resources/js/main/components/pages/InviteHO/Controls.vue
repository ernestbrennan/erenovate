    ...
    <div>
        ...
        <div ref="contractHeader" class="contract-comp__header">
            <div class="g-flex g-flex_row g-flex_wrap margin-10" data-v-step="ccd-3">
                ...
                <v-spacer class="hidden-md-and-up"></v-spacer>
                <button class="main-btn main-btn_full-green" data-v-step="ccd-1" @click="validateContract('dialog_create_draft')">
    ...
    export default {
        ...
        methods: {
            ...
            saveArchivedDraft(title) {
                ...
                api.post('archived-draft.save', params).then(response => {
                    this.loading = false;
            ...
            updateArchivedDraft() {
                ...
                api.post('archived-draft.update', params).then(response => {
                    this.loading = false;
            ...
            createDraft(comment) {
                ...
                api.post('project.inviteHO', params).then(response => {
                    this.loading = false;
                    this.dialog_create_draft = false;
                    ...
                    if (error.response.data.message.role_contractor) {
