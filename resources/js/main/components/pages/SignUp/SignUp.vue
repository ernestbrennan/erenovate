            ...
            <div class="full-window__std-col sign-up__form-wrapper">
                <div class="full-window__inner-box sign-up__form-box">
                    <div class="sign-up__form-inner">
                        <img class="sign-up__mobile-logo" src="/img/ereno_logoshield_horizontal_gray.svg" alt="">
                        <div class="sign-up__text-left-box">
                            <h2 class="sign-up__title">
                                Project Scope by eRenovate
                            </h2>
                            <p class="sign-up__header-text">
                                Our easy-to-use platform is free and easy to get
                                started.
                                Track and manage projects with your Pro like never before.
                            </p>
                            <p class="sign-up__header-text">
                                Already have an account?
                                <span @click="toSignIn" class="sing-up__blue-link"> Log in here</span>
                            </p>
                        </div>
                        ...
                        <div class="full-window__form-els">
                            <label class="full-window__form-input-label">
                                Registration type
                            </label>
                            <div class="switch-btns">
                                <button class="switch-btns__btn left" :class="{'active': role === 'homeowner'}" @click="role = 'homeowner'">
                                    I'M A HOMEOWNER
                                </button>
                                <button class="switch-btns__btn right" :class="{'active': role === 'contractor'}" @click="role = 'contractor'">
                                    I'M A PRO
                                </button>
                            </div>
                        ...
                        <div class="full-window__form-els">
                            <button class="full-window__btn-green" @click="signUp">
                                <span>SIGN UP</span>
                            </button>
                        </div>
                    </div>
            ...
            <div class="full-window__std-col sign-up__bckg-box">
                <div class="full-window__inner-box sign-up__info-box">
                    ...
                    <div class="sign-up__partners-box">
                        <div class="sign-up__partners-title">
                            Trusted by Bonded Pros™, homeowners and our group of Partners;
                        </div>
