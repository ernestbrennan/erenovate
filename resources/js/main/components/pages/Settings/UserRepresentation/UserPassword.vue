<template>
    <div class="settings__change-pass-wrapper">
        <div class="contract-draft__input-box">
            ...
            <input :class="{'invalid-input':  errors.has('current_pass'),'scroll__invalid-input':  errors.has('current pass') }"
        ...
        <div class="contract-draft__input-box">
            ...
            <input :class="{'invalid-input':  errors.has('new_pass'),'scroll__invalid-input':  errors.has('new_pass') }"
                   class="contract-draft__input"
        ...
        <div class="contract-draft__input-box">
            ...
            <input :class="{'invalid-input':  errors.has('confirm_new_pass'),'scroll__invalid-input':  errors.has('confirm_new_pass') }"
                    class="contract-draft__input"
    ...
    export default {
        ...
        methods: {
            ...
            saveNewPass() {
                ...
                api.post('setting.changePassword', {
