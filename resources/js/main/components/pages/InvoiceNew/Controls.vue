<template>
    <div>
        ...
        <create-invoice-dialog :milestone_sequence="invoice.milestone.sequence"
        ...
        <template v-if="get_tour">
            <v-tour name="tourInvoice" :steps="steps" :options="optionsVueTour" :callbacks="tourCallbacks"></v-tour>
        </template>
    </div>
</template>
<script>
