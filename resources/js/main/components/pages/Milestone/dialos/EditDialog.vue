            ...
            <div class="main-dialog__body">
                ...
                <div class="main-dialog__text-box">
                    <p class="main-dialog__p">
                        You are about to propose milestone edits, which will be reviewed by the {{ user.role === 'homeowner' ? 'PRO' : 'Client'}}. We will notify you once proposed edits are accepted or declined.
                    </p>
                </div>
