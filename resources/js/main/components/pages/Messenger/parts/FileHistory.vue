        ...
        <div class="chat">
            ...
            <div :style="{height: component_container_height}" class="chat__body scrollbar" ref="scrollBlock">
                <div class="chat__inner">
                    <div v-if="!fileHistory.entities.length" class="chat__empty-messeges" :style="{'min-height': this.$store.state.chatBodyHeight + 'px'}">
                        <div class="chat__empty-box">
                            ...
                            <template v-if="user === 'homeowner'">
                                <p class="common-p text-xs-center">
                                    When you attach files (upload) to platform messages, projects, milestones or payment details, you can easily view them on this File History area.
                                </p>
                                <p class="common-p text-xs-center">
                            ...
                            <template v-else>
                                <p class="common-p text-xs-center">
                                    Any project files you upload to the platform, or messages, projects, milestones or payment details, you can easily view them on this File History area.
                                </p>
                                <p class="common-p text-xs-center">
                    ...
                    <div v-else v-for="entity in fileHistory.entities" data-v-step="fh-2" class="chat-message">
                        ...
                        <message :message="entity" data-v-step="fh-3" :user="user.userId === entity.sender_id ? user : fileHistory.target_user"/>
