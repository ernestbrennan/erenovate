<template>
    <div>
        <v-dialog content-class="main-dialog__scroll-content scrollbar" v-model="dialogMain" light max-width="556">
            <div class="main-dialog main-dialog_open">
                ...
                <div class="main-dialog__body">
                    ...
                    <div v-if="typeof currentDialog.comment !== 'undefined' || currentDialog.comment !== false"
        ...
        <accept-dialog v-model="dialog_confirm" :loading="loading" :milestone_sequence="invoice.milestone.sequence" @confirm="confirmInvoice"/>
            ...
            <div class="g-flex g-flex_row g-flex_wrap margin-10 g-flex_vertical-center">
                ...
                <template v-if="user.role === 'homeowner'">
                    ...
                    <template v-if="invoice.status === 'pending' || invoice.status === 'unverified'">
                        ...
                        <div class="contract-header__contract-label contract-label_orange hidden-md-and-down"
                        ...
                        <button class="main-btn main-btn_full-green ciho-5-class ciho-6-class"
                ...
                <template v-if="user.role === 'contractor'">
                    ...
                    <template v-if="invoice.status === 'pending' || invoice.status === 'unverified'">
                        ...
                        <v-spacer class="hidden-md-and-down"></v-spacer>
                        <v-spacer class="hidden-md-and-up"></v-spacer>
                        <button class="main-btn main-btn_border-green hidden-md-and-down"
                                @click="dialog_complete = true">
                            CONFIRM PAYMENT
                        </button>
                        <v-spacer class="hidden-md-and-up"></v-spacer>
                        <v-menu class="hidden-md-and-down" offset-y left nudge-top="-16">
                            <button class="main-btn contract-header__dropmenu-box main-btn_border-blue"
                                    slot="activator">
...
<script>
    import {currentDialog, dialogReject, dialogUnverify} from '../../dialog/invoiceCurrent'
