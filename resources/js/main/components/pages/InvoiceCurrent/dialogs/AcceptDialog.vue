        ...
        <div class="main-dialog main-dialog_open">
            ...
            <div class="main-dialog__body">
                <p class="main-dialog__p">
                    As the client, I accept the Payment Request for this Milestone {{milestone_sequence}}, and confirm I sent payment.
                </p>
                <p class="main-dialog__p">
...
<script>
    ...
    import FileAttachmentsDialog from '../../../common/FileAttachmentsDialog';
