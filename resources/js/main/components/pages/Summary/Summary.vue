    ...
    <div class="contract-comp">
        <div class="row row-mobile">
            <div class="col-xl-9 col-lg-12 col-12 custom-col-mobile">
                ...
                <template v-if="summary && !waitingState">

                    <controls/>

                    <summary-builder :summary="summary"/>
...
<script>
    ...
    export default {
        ...
        computed: {
            waitingState() {
                return ['pending', 'signed'].includes(this.summary.contract.status)
            },
            ...
            completedState() {
                return this.summary.contract.status === 'completed'
            },
