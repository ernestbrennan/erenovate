<template>
    ...
    >
        ...
        <template v-if="!readOnly">
            <div data-v-step="ccd-10" :class="{'attch-history_disabled': readOnly, 'hasOpenBatch': $store.state.hasNewBatch}"
                    ...
                    <template v-if="!hasFiles">
                        <div class="empty-box">
                            <img src="/img/drag-drop_gray.svg" alt="">
                                ...
                                <p v-if="$route.name === 'create-invoice'">
                                    Drag and Drop related files to send with Payment Request
                                </p>

                                <p v-else>
                                    Drag and Drop Files to Attach <br> or
                                </p>
        ...
        <!--<div v-if="has_changed_files"-->
            <!--style="color:rgba(45, 156, 219, 0.8);font-weight: 500;"-->
            <!--class="has_changed_files-message"> {{changed_description}}</div>-->
