            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="contract-draft__input-box">
                        ...
                        <input :class="{'invalid-input':  errors.has('first_milestone_price') ,'scroll__invalid-input':  errors.has('first_milestone_price')}"
...
<script>
    ...
    import ContractAttachment from "../../../common/ContractAttachment.vue"
