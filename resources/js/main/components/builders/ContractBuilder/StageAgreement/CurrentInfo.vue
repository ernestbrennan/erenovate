    ...
    <div class="contract-draft__gray-box contract-draft__gray-box_min-height contract-draft__personal-data">
        ...
        <form>
            ...
            <template v-if="current.type === 'legal'">
                ...
                <div class="contract-draft__input-box">
                    <label
                            :class="{'invalid-input':  errors.has('company name') }"
                ...
                <div class="contract-draft__input-box">
                    <label
                            :class="{'invalid-input':  errors.has('representative') }"
                            class="contract-draft__input-label"
                ...
                <div class="contract-draft__input-box g-flex g-flex_row g-flex_wrap" v-if="!canCurrentEdit">
                    <label
                        ...
                        <input type="checkbox"
                               ...
                               v-validate="'required'"
                        >
                        <span :class="{'invalid-input':  errors.has('company_checkbox'), 'scroll__invalid-input':  errors.has('company_checkbox') }"></span>
                    </label>
            ...
            <div class="contract-draft__input-box">
                <label class="contract-draft__input-label" :class="{'invalid-input':  errors.has('address 1') }">Address Line 1</label>
                <input type="text"
                       name="address 1"
                       class="contract-draft__input"
            ...
            <div class="contract-draft__input-box">
                <label
                        :class="{'invalid-input':  errors.has('city')}"
                        class="contract-draft__input-label"
                >City</label>
                <input type="text"
                       name="city"
            ...
            <div class="contract-draft__input-box">
                <label
                        :class="{'invalid-input':  errors.has('province')}"
                        class="contract-draft__input-label"
                >Province</label>
                <input type="text"
                       name="province"
            ...
            <div class="contract-draft__input-box">
                <label
                        :class="{'invalid-input':  errors.has('postal code')}"
                        class="contract-draft__input-label"
                >Postal Code</label>
                <input type="text"
                       name="postal code"
        ...
        methods: {
            ...
            cancelEditing() {
                ...
                api.post('user.getUserInfo', {id: this.current.id})
                    .then(response => {
                        this.$store.commit('updateContractProp', {prop: 'current_user_info', value: response.data});
            ...
            applyEditing() {
                const timer = setTimeout(()=>{
                    if ($('.contract-draft__personal-data .invalid-input').length <= 0) {
                        this.$store.dispatch('updateUserInfo', this.current).then(response => {
                            this.current_edit = false
                        });
                        clearTimeout(timer)
