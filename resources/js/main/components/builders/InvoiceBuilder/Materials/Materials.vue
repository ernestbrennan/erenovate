    ...
    <div>
        <div class="contract-draft__border-title" data-v-step="ci-5" v-if="materials.length || !this.readOnly">
            ...
            <v-tooltip right>
                ...
                <span>This section provides list of the materials that may need to be identified for completion of this milestone. </span>
            </v-tooltip>
        </div>
        ...
        <div class="contract-materials" data-v-step="ciho-3" v-if="materials.length || !this.readOnly">
            ...
            <materials-file-attachments v-if="!readOnly || material_files.length"
