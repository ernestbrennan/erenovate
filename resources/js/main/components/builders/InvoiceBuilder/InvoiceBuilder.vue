            ...
            <div class="contract-draft__slide-main-box contract-draft__gray-box_invoice contract-draft__gray-box"
                ...
                <template v-if="is_file_render">
                    <v-tooltip right>
                        ...
                        <span>Attach milestone related receipts or back-up documents you consider necessary to support your payment request.</span>
                    </v-tooltip>
                </template>

                <invoice-attachments :readOnly="readOnly" :batches="invoice.batches" />

                <contract-materials :materials="invoice.materials"
...
<script>
    ...
    import InvoiceAttach from '../../common/FileAttachments'
