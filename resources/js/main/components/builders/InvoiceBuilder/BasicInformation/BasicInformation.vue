    ...
    <div class="contract-draft__el-box">
        ...
        <div ref="arguments_box"
            ...
            <div class="contract-draft__input-box">
                ...
                <input placeholder="Enter Payment request title"
                       type="text"
            ...
            <div class="contract-draft__input-box">
                ...
                <input placeholder="Enter payment request number"
                       type="text"
                       class="contract-draft__input"
                       key="contract_title"
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="contract-draft__input-box">
                        <label class="ci-4 contract-draft__input-label"
                               :class="{'invalid-input':  errors.has('creation date') }">
                            Created On
                        </label>
                        <input-date v-model="invoice.creation_date"
                                    :isValidate="true"
                                    :readOnly="readOnly"
                                    label="creation date"
                                    v-validate="'required'"
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="contract-draft__input-box">
                        ...
                        <input-date v-model="invoice.due_date"
                                    :isValidate="false"
                                    :readOnly="readOnly" />
                    </div>
                </div>
