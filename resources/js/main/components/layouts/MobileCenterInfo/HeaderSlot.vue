    ...
    <div class="hidden-md-and-up header-slot">
        ...
        <template v-else-if="this.$route.name === 'notes' || this.$route.name === 'messages'">
            <div class="messeges-and-notes__tabs">
                <v-btn :class="{active: this.$route.name === 'messages'}"
                       flat
                ...
                <v-btn :class="{active: this.$route.name === 'notes'}"
                       flat
        ...
        <template v-else-if="this.$route.name === 'contract-signed' || this.$route.name === 'list-invoice' || this.$route.name === 'history-invoice' || this.$route.name === 'current-invoice' || this.$route.name === 'completed-milestone'">
