            ...
            <v-layout column fill-height>
                ...
                <div class="sidebarList">
                    <ul class="sidebarList__list-main">
                        ...
                        <a @clicl.prevent>
                            <li :class="{'active': $route.name !== 'settings' && $route.name !== 'archived-drafts-list' && $route.name !== 'invite-ho' }"
                        ...
                        <a v-if="user.role === 'contractor'" @click="toArchivedDraftList">
                            <li class="sidebar__el-menu sidebar-el_default"
                        ...
                        <li @click="goToSettings" class="sidebar__el-menu sidebar-el_default"
