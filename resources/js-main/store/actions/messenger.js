import {byProjectChat} from '@/api/chat';
import {getHistoryFile} from '@/api/file';

export default {
  getChat(context, guarantee_project_id) {
    return new Promise((resolve) => {
      byProjectChat(guarantee_project_id).then(response => {
  ...
  getFileHistory(context, guarantee_project_id) {
    return new Promise((resolve) => {
      ...
      getHistoryFile(guarantee_project_id).then(response => {
