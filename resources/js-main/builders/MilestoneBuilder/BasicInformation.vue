  ...
  <div class="contract-draft__el-box">
    ...
    >
      ...
      <div class="contract-draft__input-box">
        <label class="contract-draft__input-label" :class="{'invalid-input':  errors.has('title')}" data-v-step="mls-3">
          Milestone Title
        </label>
        <input
          ...
          key="title"
        >
        <div v-if="errors.has('title')" class="invalid-message">{{ errors.first('title') }}</div>
      ...
      <div class="contract-draft__input-box">
        ...
        <div v-if="errors.has('description')" class="invalid-message">{{ errors.first('description') }}</div>
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
          <div class="contract-draft__input-box">
            <label class="contract-draft__input-label" :class="{'invalid-input':  errors.has('start_date')}">
              Approx. Start Date
            </label>

            <input-date
              v-model="milestone_content.start_date"
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
          <div class="contract-draft__input-box">
            ...
            <input-date
              v-model="milestone_content.end_date"
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
          <div class="contract-draft__input-box">
            ...
            <input
              ...
              min="0.01"
            >
            <div v-if="errors.has('price')" class="invalid-message">{{ errors.first('price') }}</div>
      ...
      <template v-if="milestone_content.batches.length || !read_only_milestone">
        <div class="contract-draft__input-box">
          ...
          <file-attachments
            :batches="milestone_content.batches"
