  ...
  <div>
    <template v-if="collapseRender">
      <div class="contract-materials__row"
           :class="{'has-changes' : old_material === undefined, 'flex-start-mod' : materials_has_changes }">
    ...
    <template v-else>
      <div class="material-collapse">
        <div ref="materialHeader" class="material-collapse__header">
        ...
        <div class="material-collapse__body">
          ...
          >
          <div
            v-if="isPreviousChanged('title')"
            style="margin-top: -25px; margin-bottom: 30px;"
            class="old-version-message"
          >
            Previous value : {{ old_material['title'] }}
          </div>
          ...
          >
          <div
            v-if="isPreviousChanged('quantity')"
            style="margin-top: -25px; margin-bottom: 30px;"
            class="old-version-message"
          >
            Previous value : {{ old_material['quantity'] }}
...
<script>
  import money from "@/components/mixins/money/money"
