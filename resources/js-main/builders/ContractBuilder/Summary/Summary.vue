<template>
  <div class="contract-draft__el-box">
    <div class="contract-draft__title-box" @click="openSection">
      <v-tooltip right>
        <div slot="activator" class="contract-draft__title">
          Project Summary
      ...
      <div class="contract-draft__el-controls">
        <img :src="'/img/icon/caret-icon_gray.svg'" class="contract-draft__curret" :class="{active : openstate}">
      </div>
    </div>
    <div class="contract-draft__slide-main-box contract-draft__gray-box" :class="classFull" ref="summary_box">
