<template>
  <div>
    <div
      class="contract-draft__border-title"
    ...
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" v-if="!readOnly" style="display:none !important;">
        <v-tooltip right>
          ...
          <span>
            If any materials are to be listed (or added), select if they will be listed by the related Milestone or an overall list for the entire project.
          </span>
        </v-tooltip>
        <div class="toggle-buttons toggle-buttons_mobile-column">
          <button
    ...
    <template v-if="milestone_content.materials_provide_on === 'contract'">
      <div class="contract-materials">
        ...
        <materials-file-attachments
          v-if="!readOnly || milestone_content.material_files.length"
          :readOnly="readOnly"
