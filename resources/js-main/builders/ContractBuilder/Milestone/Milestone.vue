  ...
  <div class="contract-draft__el-box" :class="'milestone_' + (index + 1)">
    <div class="contract-draft__title-box">
      ...
      <div class="contract-draft__el-controls">
        ...
        <img
          class="contract-draft__delete-mileston"
          v-if="!readOnly"
          src="/img/icon/stop_gray.svg"
          @:click="$emit('removeMilestone', index)"
        >

        <img src="/img/icon/order_gray.svg" class="contract-draft__order-mileston" v-if="!readOnly">

        <img
          src="/img/icon/caret-icon_gray.svg"
    ...
    <div class="contract-draft__slide-main-box contract-draft__gray-box" :class="class_full" ref="milestone_box">
      ...
      <div class="contract-draft__input-box">
        <v-tooltip right>
          ...
          <span
            class="inner-tooltip">The Milestone title should clearly identify the related stage of the project</span>
        </v-tooltip>
        <input
      ...
      <template v-if="!readOnly">
        <v-tooltip right>
          <label class="contract-draft__input-label" slot="activator">
            File Attachments
            <img class="contract-draft__tooltip" :src="'/img/icon/info-icon_gray.svg'">
          </label>
          <span>
      ...
      <file-attachments
        :id_dropzone="'milestone_'+( index + 1)"
        :readOnly="readOnly"
...
<script>
  ...
  import {resizeTextareaReadOnly, nextTickResize} from '@/components/common/Mixins/textarea'
