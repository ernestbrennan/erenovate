  ...
  <div class="summary-block">
    ...
    <div class="summary-block__gray-box">
      <p class="summary-block__complete-text">
        To complete the Project and activate your 88 Day Workmanship Guarantee,
        we kindly ask you to review your experience working with the Bonded Pro, plus confirm the final Project Price.
        If the final project price you paid is different than shown above click the Report a Price Variance link below
        <b>after writing your review</b>.
      </p>
      <p class="summary-block__complete-text">
        <b>Note:</b>
        Confirming final Project Price is required to activate the 88 Day Workmanship Guarantee for your project.
        Failure to report a Price Discrepancy (ex. If final Project Price is higher than shown above) may result
        in a loss of compensation or coverage by the 88 Day Guarantee.
      </p>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        ...
        price_modification: 'summary/price_modification',
      })
    },
    methods: {
      clearError() {
      ...
      priceModification() {
        if (this.price_modification) {
          return this.$router.push({
            name: 'issue',
            params: {
              guarantee_project_id: this.$route.params.guarantee_project_id,
              issue_id: this.price_modification.id,
            }
          })
        }
