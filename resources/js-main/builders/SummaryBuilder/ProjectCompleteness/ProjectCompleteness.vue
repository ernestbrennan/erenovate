  ...
  <div class="summary-block">
    ...
    <div class="summary-block__gray-box">
      <template v-if="user.role === 'contractor'">
        ...
        <template v-if="summary_contract.ho_confirm_complete">
          <div class="summary-block__ta-center">
            ...
            <p class="summary-block__text-st">
              Project Price has changed since the initial Project Details Scope.
              You are required to pay the additional Project Guarantee Fee to complete this project and to activate
              the client's 88 Day Workmanship Guarantee period. Please pay additional fee by clicking the button below…
            </p>
        ...
        <template v-else>
          <div class="summary-block__ta-center">
            ...
            <p class="summary-block__text-st">
              ...
              Waiting for the homeowner (client) to accept the Project as completed.
              Once clients confirms Project Completion, the 88 Day Workmanship Guarantee period begins.<br>
      ...
      <template v-else>
        <div class="summary-block__ta-center">
          ...
          <p class="summary-block__text-st">
            Your Project Completed status is Pending, while an eRenovate Project Advisor reviews the final Project
            Summary. Once approved, the 88 Day Workmanship Guarantee for your project will begin.
          </p>
        </div>
      </template>
