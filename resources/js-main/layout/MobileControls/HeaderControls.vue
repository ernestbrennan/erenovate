<template>
  <div class="header-controls hidden-md-and-up">
    ...
    <template v-else-if="this.$route.name === 'contract-history'">
      <img class="header-controls__single-icon" @click="toCurrentDraft" src="/img/icon/contract-history-header.svg"
           alt="to_current">
    </template>
    ...
    <template v-else-if="this.$route.name === 'list-invoice'">
      <img class="header-controls__single-icon" @click="toMessages" src="/img/icon/invoiceheader_gray.svg"
           alt="to_current">
    </template>
