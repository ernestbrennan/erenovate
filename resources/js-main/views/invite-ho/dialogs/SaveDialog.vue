    ...
    <div class="main-dialog main-dialog_open">
      ...
      <div class="main-dialog__body">
        <p class="main-dialog__p">
          You are about to save Project Scope Draft without submitting it to the client. It will be available on the
          "Drafts" page. You can get back to editing it later.
        </p>
