<template>
  <div class="contracts-comp">
    <div
      :class="{ slide: slideSearchContracts , 'project-list__contractor': invite_ho}"
    ...
    >
      ...
      <v-btn fab depressed class="cotracts-comp__submit-btn" @click="getContracts">
        <img :src="'/img/icon/arrow_gray.svg'" alt="">
      </v-btn>

      <button class="main-btn main-btn_full-blue" v-if="invite_ho" @click="toInvite">
        START A PROJECT
      </button>
    ...
    <div class="contracts-comp__body scrollbar">
      <template v-if="contracts.length">
        <div
          ...
          :key="index"
          @click="toProjectChat(contract.guarantee_project_id, true)"
          class="contract-list"
        >
        ...
        <div class="contract-list__no-contracts">
          <div class="contract-list__no-contracts-inner">
            ...
            <template v-if="!query_search">
              <img class="common-img_center common-img_m-b-40-35" src="/img/contracts-list_empty.svg" alt="empty">
              <template v-if="user.role === 'contractor'">
                ...
                <p class="common-p">
                  ...
                  <a
                    class="common-link common-link_blue"
                    href="https://erenovate.com/contractors/Tutorials"
                    target="_blank"
                  >
                    here
                  </a>.
              ...
              <template v-else>
                ...
                <p class="common-p">
                  To create your first Project on eRenovate, simply click the Post A Project button below.
                  We will match your project to 3 Bonded Pros.
                  Once you decide which Pro to hire, click the <b>Hire with Guarantee</b>
                  button to ensure your project is covered by the eRenovate Guarantee!
                </p>
                <p class="common-p">
                  Have questions about the eRenovate Guarantee? <br> Feel free to
            ...
            <template v-else>
              ...
              <p class="common-p">
                ...
                <a class="common-link" href="https://www.erenovate.com/homeowners/contact">Contact Us.</a>
              </p>
              <button
                data-v-step="cl-3"
                class="common-btn common-btn_blue"
                @click="query_search = ''; getContracts()"
              >
                CLEAR SEARCH
              </button>
      ...
      <template v-if="getTour">
        <v-tour
          name="tourContracts"
          :steps="steps"
          :options="optionsVueTour"
          :callbacks="contractsCallbacks"
        />
      </template>
    </div>
  </div>
