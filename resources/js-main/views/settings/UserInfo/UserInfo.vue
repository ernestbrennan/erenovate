  ...
  <div class="contract-draft__gray-box contract-draft__gray-box_min-height contract-draft__personal-data">
    <form @submit.prevent="validateUserInformation">
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('first_name'),'scroll__invalid-input':  errors.has('first_name') }"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('last_name'),'scroll__invalid-input':  errors.has('last_name') }"
          class="contract-draft__input"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('email'),'scroll__invalid-input':  errors.has('email') }"
          class="contract-draft__input"
      ...
      <div class="contract-draft__input-box" v-if="user.role === 'contractor'">
        ...
        <input
          :class="{'invalid-input':  errors.has('website'),'scroll__invalid-input':  errors.has('website') }"
          class="contract-draft__input"
          placeholder="Website"
          data-vv-as="website"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('phone_number'),'scroll__invalid-input':  errors.has('phone_number') }"
          class="contract-draft__input"
          placeholder="Phone"
          v-validate="'required'"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('street_name'),'scroll__invalid-input':  errors.has('street_name') }"
          class="contract-draft__input"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('street_num'),'scroll__invalid-input':  errors.has('street_num') }"
          class="contract-draft__input"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('unit_num'),'scroll__invalid-input':  errors.has('unit_num') }"
          class="contract-draft__input"
      ...
      <div class="contract-draft__input-box">
        ...
        <input
          :class="{'invalid-input':  errors.has('postal_code'),'scroll__invalid-input':  errors.has('postal_code') }"
          class="contract-draft__input"
        ...
        <div class="contract-draft__input-box">
          <label class="contract-draft__input-label">
            <span class="gray-text">
                *The Lead Radius circle defines the territory where you wish to receiveleads.
            </span>
          </label>
        </div>
      </template>
...
<script>
  ...
  import {ChildMixin} from "@/components/common/Mixins/glValidate/mixins";
