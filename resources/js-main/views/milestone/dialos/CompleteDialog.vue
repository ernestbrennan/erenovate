      ...
      <div class="main-dialog__body">
        <div class="main-dialog__text-box">
          <p class="main-dialog__p">
            This Milestone is now completed and ‘closed’, you will now be directed to create a Milestone Payment
            Request.
          </p>
          <p class="main-dialog__p">
            Once your Payment Request is submitted, client is notified and required to upload proof of payment to
            eRenovate. Once proof of payment is uploaded, client will ask you to confirm receiving payment.
          </p>
          <p class="main-dialog__p">
