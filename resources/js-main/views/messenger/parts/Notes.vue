<template>
  <messenger-content :type="type">
    <div v-if="!notes.length" class="chat__empty-messeges"
      ...
      <div class="chat__empty-box">
        ...
        <p class="common-p text-xs-center" data-v-step="nt-3">
          The notes area can be your central database to have all your relevant project information at your fingertips,
          all in one central place.
          Easily view electronic copies of original documents, make notes of key project talking points, ideas,
          inspirational images, receipts, and personal notes to help make your project less stressful.
